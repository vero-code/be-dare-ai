...
export const PICA_CREATOR_MESSAGE_ACTION_ID = getEnvVariable('VITE_PICA_CREATOR_MESSAGE_ACTION_ID');
...
export const TAVUS_PERSONA_ID = getEnvVariable('VITE_TAVUS_PERSONA_ID');